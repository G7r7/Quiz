...
/* tslint:disable */
/* eslint-disable */
import type { Body_login_for_access_token_tokenGen_post } from '../models/Body_login_for_access_token_tokenGen_post';
...
userId: number,
     ...
     * @throws ApiError
     */
    public static userMeUsersMePost(): CancelablePromise<User> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/users/me',
        });
...
m: number = 5,
     ...
     * @throws ApiError
     */
    public static loginForAccessTokenTokenGenPost(
formData: Body_login_for_access_token_tokenGen_post,
